...
public class PatchManager {
	...
	public PatchManager(Context context) {
		...
		Util_LOGFile.getInstance().write(TAG + "\n" + " patchDir 在" + mPatchDir.getAbsolutePath().toString());
		Log.d(TAG, " patchDir 在" + mPatchDir.getAbsolutePath().toString());
	...
	public void loadPatch() {
		...
		Set<String> patchNames;
		List<String> classes;
		for (Patch patch : mPatchs) {//遍历所有补丁
			patchNames = patch.getPatchNames();
			for (String patchName : patchNames) {//遍历该所有patch-classes中的class.
				classes = patch.getClasses(patchName);
